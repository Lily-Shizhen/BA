...
# Let's pick 5 interesting k-values:
...
##############################################################################
# 4) Plot dimension vs. loss/upper bound in a 2x5 figure
##############################################################################

# We'll have 2 rows (risk in row 0, upper bound in row 1) × len(selected_ks) columns
